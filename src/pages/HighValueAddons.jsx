        ...
        <div style={{ background: 'var(--c-bg)', minHeight: '100vh', paddingTop: '60px', transition: 'background 0.3s ease' }}>
            <section style={{ padding: '6rem 1.5rem 4rem' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <p style={{ fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--c-text-faint)', marginBottom: '1rem' }}>add-ons</p>
                    <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: 1.05, color: 'var(--c-text)', marginBottom: '1.5rem' }}>
                        high-value<br /><span style={{ color: 'var(--c-text-dim)' }}>add-ons.</span>
                    </h1>
                    <p style={{ fontSize: '1rem', color: 'var(--c-text-muted)', maxWidth: '420px', lineHeight: 1.7 }}>pair with any service to go further, faster. every add-on is designed to deliver maximum roi.</p>
                </div>
            </section>
            ...
            <section style={{ padding: '5rem 1.5rem', borderTop: `1px solid var(--c-divider)`, textAlign: 'center' }}>
                <div style={{ maxWidth: '500px', margin: '0 auto' }}>
                    <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.5rem)', fontWeight: 800, letterSpacing: '-0.02em', color: 'var(--c-text)', marginBottom: '1.5rem' }}>unsure what you need?</h2>
                    <p style={{ color: 'var(--c-text-muted)', marginBottom: '2rem', fontSize: '0.9rem', lineHeight: 1.7 }}>book a call and we'll recommend exactly which add-ons will move the needle.</p>
                    <Link to="/book-a-call" style={{ display: 'inline-block', padding: '0.85rem 2rem', background: 'var(--c-btn-bg)', color: 'var(--c-btn-text)', fontWeight: 700, borderRadius: '8px', fontSize: '0.875rem' }}>book a free call →</Link>
                </div>
            </section>
