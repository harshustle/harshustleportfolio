        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                ...
                >
                    ...
                    <div className="p-6 border-b border-white/10 flex items-center justify-between bg-white/5 sticky top-0 z-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-purple-300 text-sm">Service Workflow</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                        ...
                        <div className="relative">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative z-10">
                                {steps.map((step, index) => (
                                    ...
                                    >
                                        {/* Number Circle */}
                                        <div className="w-12 h-12 rounded-full bg-[#0f0a15] border-2 border-purple-500 flex items-center justify-center text-purple-400 font-bold shadow-lg shadow-purple-500/20 mb-4 group-hover:scale-110 transition-transform bg-[#0f0a15] z-10">
                                            {index + 1}
                                        </div>

                                        {/* Content Card */}
                                        <div className="w-full bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 hover:border-purple-500/30 transition-colors h-full flex flex-col justify-start min-h-[140px]">
                                            <h3 className="text-sm font-bold text-white mb-2 leading-tight">{step.title}</h3>
                    ...
                    {/* Footer - Sticky */}
                    <div className="p-6 border-t border-white/10 bg-white/5 sticky bottom-0 z-10 flex justify-end gap-3">
                        <button
                            onClick={onClose}
                        ...
                        <button
                            ...
                            className="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-purple-500/25 transition-all"
                        >
                            Start This Process
                        </button>
                    </div>
